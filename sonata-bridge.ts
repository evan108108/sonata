...
2. Read your personality at /Users/evan/.sonata/private/personality.md
3. Read the emails using AgentMail MCP tools
4. Compose and send replies using AgentMail MCP tools
5. After replying, mark each email as replied:
   curl -s -X POST ${SONATA_API}/api/email/mark-replied -H "Content-Type: application/json" -d '{"id": "THE_ID"}'
